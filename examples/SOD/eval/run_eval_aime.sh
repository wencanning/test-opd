...
# Evaluates a trained model on AIME 2024 & AIME 2025.
# ============================================================
...
#   bash run_eval.sh <MODEL_PATH> [EVAL_SET] [hydra_overrides...]
if [[ $# -gt 0 && "${1}" != *=* ]]; then
    MODEL_PATH="$1"
    shift
fi
...
EXPERIMENT_NAME="${EXPERIMENT_NAME:-eval_${MODEL_TAG}_aime}"
